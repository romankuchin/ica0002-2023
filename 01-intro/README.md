...
[VirtualBox](https://www.virtualbox.org/wiki/Downloads) running Ubuntu as guest VM or you can run Ansible in WSL.
...
Note: we will use Ansible version 6.7.0 (ansible-core 2.13.11) for this course.
Teachers will have this version installed and use it to check your tasks.
Your code is considered working only if it executes successfully on Ansible 6.7.0.
If you're using other Ansible versions -- you're on your own with them.

Note: you will need Python v3.8 or newer to use this version of Ansible.
